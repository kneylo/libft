...
/*static char *ft_insertword(char *word, char const *s, int i; int word_len)
{
    int j;
...
static char **ft_split_word(char const *s, char c, char **res, int nb_word)
{
    int i;
    int word;
    int word_len;
...
char    **ft_split(char const *s, char c)
{
    ...
    if (!res)
        return(0);
    res = ft_split_word(s, c, res, nb_word);
    return(res);
}
